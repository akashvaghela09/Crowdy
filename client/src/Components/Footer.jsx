...
const Footer = () => {
    return (
        <div className='bg-slate-700 flex p-8 border-t-2 border-slate-600 flex-col md:flex-row pb-24 md:p-8'>
            ...
            <div className='flex items-center my-2 md:p-4 md:mx-4 md:my-0'>
                <p className='text-slate-300 font-thin text-md ml-2'>© 2022 Crowdy — <a href='https://linkedin.com/in/akashvaghela09' rel="noreferrer" target="_blank">@akashvaghela09</a></p>
            </div>
        </div>
    )
}
