...
const RaiseFund = () => {
    ...
    return (
        <div className='h-fit flex justify-center items-center flex-col'>
            ...
            <div className='bg-slate-300 w-4/5 py-12 h-fit drop-shadow-md rounded-md flex flex-col justify-center items-center mb-16'>
                <div className='flex flex-col md:flex-row items-center gap-10 md:justify-evenly md:items-stretch w-full grow'>
                    <div className='flex justify-center flex-col w-4/5 md:w-2/5'>
                    ...
                    <div className='relative flex justify-between items-center flex-col w-4/5 md:w-2/5 border-4 p-6 border-dashed border-slate-800 rounded-md h-96 md:h-auto'>
                        {
                            image === "" ?
                        ...
                        <label className='w-4/5 p-2 rounded-md text-xl text-center active:translate-y-1 bg-blue-500 text-neutral-100 hover:bg-blue-600'>
                            <input type="file" className="absolute top-0 left-0  w-4/5 p-1 rounded hidden" onChange={(e) => handleImageSelect(e)} />
                            {
                ...
                <button onClick={() => handleSubmit()} className='p-2 mt-16 w-96 rounded-md active:translate-y-1 bg-blue-500 text-neutral-100 hover:bg-blue-600 text-xl'>Submit Application</button>
            </div>
        </div>
    )
}
